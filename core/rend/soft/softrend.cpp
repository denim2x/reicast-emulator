...
/*
	Pure-software renderer (denim2x)
...
#include "rend/util.h"
//#include "rend/soft/PixelFlush.h"   // Used indirectly
//#include "rend/soft/PlaneStepper.h" // Not used
#include "rend/soft/RendTriangle.h"
...
/**
 * This function is prone to giving false positives
 * FIXME: when *any* of the 3 tests fails -> *any* test fails.
 **/
	...
	void RenderParamList(List<PolyParam>* param_list, RECT* area) {
		...
		for (int i = 0; i < param_count; i++)
		{
			...
			for (int v = 0; v < vertex_count; v++) {
				...
				RendTriangle rendTriangle(alpha_mode, params[i].tsp.UseAlpha, params[i].pcw.Texture, params[i].tsp.IgnoreTexA, params[i].tsp.ShadInstr, params[i].pcw.Offset);
